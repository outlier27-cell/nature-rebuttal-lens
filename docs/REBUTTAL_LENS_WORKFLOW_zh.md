...
2. ReviewerUnderstandingAgent：拆解 reviewer 明面请求。
3. TacitConcernInterpreterAgent：解释可观察文本中的隐含风险，不推断私人心理。
4. ManuscriptEvidenceLocatorAgent：定位 reviewer concern 在原文中的支持、缺口或不确定点。
...
8. AuthorPositioningAgent：给出回应姿态选项，保留作者主体性。
...
11. CrossDisciplinaryLensInterpreterAgent：输出默会知识边界、制度依赖、行动者网络对齐、快慢思维校正、情绪-语气-承诺校准、作者主体性门控。
